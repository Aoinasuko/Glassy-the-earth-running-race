...
{
	public class Glassy_Settings : Mod
	{
		public Glassy_Settings(ModContentPack content) : base(content)
		{
			GetSettings<Glassy_Config>();
		}

		public override string SettingsCategory()
		{
			return "Glassy.Config.Title".Translate();
		}

		public override void DoSettingsWindowContents(Rect inRect)
		{
			Glassy_Config.DoWindowContents(inRect);
		}
	}

	public class Glassy_Config : ModSettings
	{
		// バージョン
		public static int ver = 222;
		...
		public static void DoWindowContents(Rect inRect)
		{
			...
			if (listingStandard.ButtonText("Glassy.Config.Update".Translate()))
			{
				Updatever = ver;
