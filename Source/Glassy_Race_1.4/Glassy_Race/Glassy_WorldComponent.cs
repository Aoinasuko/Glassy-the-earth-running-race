...
{
	public class Glassy_WorldComponent : WorldComponent
	{

		public Glassy_WorldComponent(World world)
			: base(world)
		{
		}
		...
		public override void WorldComponentTick()
		{
			...
			{
				// 現在のバージョン
				if (Glassy_Config.Updatever < Glassy_Config.ver)
				{
					Glassy_Config.Updatever = Glassy_Config.ver;
					Dialog_Update dialog = new Dialog_Update();
					Find.WindowStack.Add(dialog);
					LoadedModManager.GetMod<Glassy_Settings>().WriteSettings();
				}
			}
		}
	...
	public class Dialog_Update : Window
	{
		...
		{
			Texture2D texture_update = ContentFinder<Texture2D>.Get("Glassy/UI/Update");
			Texture2D texture_nasuko = ContentFinder<Texture2D>.Get("Glassy/UI/Alby");
			...
			listingStandard.Label("Glassy.Update.Title".Translate());
			...
			listingStandard.Label("Glassy.Update.label".Translate());
			listingStandard.End();
